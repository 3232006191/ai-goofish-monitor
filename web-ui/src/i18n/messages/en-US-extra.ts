const enUSExtra = {
  tasks: {
    ...
    form: {
      ...
      autoCompare: 'Auto Compare',
      autoCompareHint: 'When enabled, after each Goofish scrape the system will automatically search Paijitang for the same model to compare prices. This adds extra search time.',
